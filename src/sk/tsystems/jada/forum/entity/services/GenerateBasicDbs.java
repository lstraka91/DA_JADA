...
public class GenerateBasicDbs {
	...
	private Commentary comment3 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic5);
	private Commentary comment4 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic6);
	private Commentary comment5 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic7);
	private Commentary comment6 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic8);
	private Commentary comment7 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic9);
	private Commentary comment8 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic10);
