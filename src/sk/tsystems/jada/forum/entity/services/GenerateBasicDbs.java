...
public class GenerateBasicDbs {
	...
	private Commentary comment1 = new Commentary("Hardver je súhrnný názov pre technické vybavenie poèítaèa a poèítaèových komponentov.", admin1, topic1);
	private Commentary comment2 = new Commentary("Medzi hardvér patria všetky poèítaèe a ich súèasti.", admin1, topic1);
	private Commentary comment3 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic2);
	private Commentary comment4 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic3);
	private Commentary comment5 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic4);
	private Commentary comment6 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic5);
	private Commentary comment7 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic6);
	private Commentary comment8 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic7);
	...
	private Commentary comment18 = new Commentary("The first of these could be that somewhere else in your code, you are refering to the creation of the notification, and there the changes you have made would not affect the code.", admin1, topic15);
	private Commentary comment19 = new Commentary("Hardver je súhrnný názov pre technické vybavenie poèítaèa a poèítaèových komponentov.", admin1, topic3);
	private Commentary comment20 = new Commentary("Medzi hardvér patria všetky poèítaèe a ich súèasti.", admin1, topic15);
	private Commentary comment21 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic14);
	private Commentary comment22 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic13);
	private Commentary comment23 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic12);
	private Commentary comment24 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic11);
	private Commentary comment25 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic10);
	private Commentary comment26 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic9);
	private Commentary comment27 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic8);
	private Commentary comment28 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic7);
	private Commentary comment29 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic6);
	private Commentary comment30 = new Commentary("In Postgres system catalogs are the basic set of complete information about the installation and databases.", admin1, topic5);
	private Commentary comment31 = new Commentary("If you already have logging enabled and you still get this error on Windows 7 64 bit, try this in IIS 7.5:", admin1, topic4);
	private Commentary comment32 = new Commentary("If these buttons are disabled, go back to the start menu, right-click the Log Viewer, and select Run as Administrator.", admin1, topic3);
	private Commentary comment33 = new Commentary("You just find solutions just like if it is a regular system, so you may possibly find infinetly many solutions:", admin1, topic2);
	private Commentary comment34 = new Commentary("I would try the following approach (note that I never had to deal with that problem, so take this answer as an attempt to solve with you the problem instead of a real analytical answer).", admin1, topic2);
	private Commentary comment35 = new Commentary("This is more likely to happen. The build has broken down and your built version of the app is not using the latest code. You can solve this by rebuilding the app from your IDE.", admin1, topic1);
	private Commentary comment36 = new Commentary("The first of these could be that somewhere else in your code, you are refering to the creation of the notification, and there the changes you have made would not affect the code.", admin1, topic1);	
	private Commentary comment37 = new Commentary("The first of these could be that somewhere else in your code, you are refering to the creation of the notification, and there the changes you have made would not affect the code.", admin1, topic8);
	private Commentary comment38 = new Commentary("Hardver je súhrnný názov pre technické vybavenie poèítaèa a poèítaèových komponentov.", admin1, topic7);
	private Commentary comment39 = new Commentary("Medzi hardvér patria všetky poèítaèe a ich súèasti.", admin1, topic6);
	private Commentary comment40 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic1);
	private Commentary comment41 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic3);
	private Commentary comment42 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic2);
	private Commentary comment43 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic4);
	private Commentary comment44 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic12);
	private Commentary comment45 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic13);
	private Commentary comment46 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic14);
	private Commentary comment47 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic15);
	private Commentary comment48 = new Commentary("Softver je oznaèenie pre programové vybavenie poèítaèa", admin1, topic15);
	private Commentary comment49 = new Commentary("In Postgres system catalogs are the basic set of complete information about the installation and databases.", admin1, topic3);
	private Commentary comment50 = new Commentary("If you already have logging enabled and you still get this error on Windows 7 64 bit, try this in IIS 7.5:", admin1, topic9);
	private Commentary comment51 = new Commentary("If these buttons are disabled, go back to the start menu, right-click the Log Viewer, and select Run as Administrator.", admin1, topic5);
	private Commentary comment52 = new Commentary("You just find solutions just like if it is a regular system, so you may possibly find infinetly many solutions:", admin1, topic11);
	private Commentary comment53 = new Commentary("I would try the following approach (note that I never had to deal with that problem, so take this answer as an attempt to solve with you the problem instead of a real analytical answer).", admin1, topic7);
	private Commentary comment54 = new Commentary("This is more likely to happen. The build has broken down and your built version of the app is not using the latest code. You can solve this by rebuilding the app from your IDE.", admin1, topic6);
	private Commentary comment55 = new Commentary("The first of these could be that somewhere else in your code, you are refering to the creation of the notification, and there the changes you have made would not affect the code.", admin1, topic10);
