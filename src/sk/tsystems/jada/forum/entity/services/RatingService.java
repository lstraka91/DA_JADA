...
public class RatingService {
	...
	/**
	 * Method that try to save object from parameter to the Database by
	 * hibernate. in function is checking if the rating object already exists in
	 * database and if no that its create a new one otherwise if exist it just
	 * update existing object to new values from parameter
	 * 
	 * Use the {@link RatingService #checkIfRatingExist(Rating)} method
	 * 
	 * Use the {@link RatingService #createRating(Rating)} method
	 * 
	 * Use the {@link Rating #getRate()} method
	 * 
	 * Use the {@link RatingService #getRatingByRating(Rating)} method
	 * 
	 * Use the {@link RatingService #updateRating(Integer, Rating)} method
	 * 
	 * @param rating
	 ...
	 * 
	 * Use the {@link Rating #setRate(Integer)} method
	 * 
	 * @param rating
	 * 
	 * @see Rating
